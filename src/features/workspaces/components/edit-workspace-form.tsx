...
export const EditWorkspaceForm = ({
  ...
  return (
    <div className="flex flex-col gap-y-4">
                  ...
                  render={({ field }) => (
                    <div className="flex flex-col gap-y-2">
                      <div className="flex items-center gap-x-5">
                        {field.value ? (
                          <div className="size-[72]px relative rounded-md overflow-hidden">
                            <Image
                              alt="Logo"
                              fill
                          ...
                          <Avatar className="size-[72]px">
                            <AvatarFallback>
                              <ImageIcon className="size-[36]px text-neutral-400" />
                            </AvatarFallback>
                          </Avatar>
                        )}
      ...
      <Card className="w-full h-gull border-none shadow-none">
        <CardContent className="p-7">
          <div className="flex flex-col">
